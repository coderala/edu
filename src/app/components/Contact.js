...
const ContactSection = () => {
  return (
    <div className="flex flex-col lg:flex-row m-5 bg-light p-5 lg:p-0 rounded-lg">
      {/* Left Image Side */}
      ...
      {/* Right Form Side */}
      <div className="w-full lg:w-1/2 flex flex-col justify-center mt-8 lg:mt-0 lg:pl-10 text-center lg:text-center gap-5 lg:p-20 ">
        <FontAwesomeIcon
          icon={faXmark}
        ...
        <p className="mt-2 text-base sm:text-xl lg:text-sm 2xl:text-base text-gray-700">
